...
public:
	...
	void display(){
		cout<<"currentConditionDisplay, temprature and pressure is "<<temprature<<" "<<pressure<<endl;
	}
};
...
public:
	...
	void display(){
		cout<<"Current Weather Display"<<endl<<"Temprature "<<temprature<<endl;
...
public:
	...
	void display(){
		cout<<"Random Display, temprature and humidity is "<<temprature<<" "<<humidity<<endl;
	}
};